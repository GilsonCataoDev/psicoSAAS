...
OBSERVAÇÕES DO(A) PROFISSIONAL:`},{id:`phq9`,title:`PHQ-9 — Rastreio de Depressão`,description:`Escala de 9 itens para rastreio de depressão. Uso clínico livre — não substitui diagnóstico.`,category:`escala`,tags:[`depressão`,`rastreio`,`PHQ-9`],ageGroups:[`adulto`,`adolescente`],Icon:c,template:`PHQ-9 — RASTREIO DE DEPRESSÃO
...
OBSERVAÇÕES DO(A) PROFISSIONAL:`},{id:`registro-pensamentos`,title:`Registro de Pensamentos Automáticos`,description:`Técnica de TCC para identificar situação, emoção, pensamento automático e alternativas.`,category:`registro`,tags:[`TCC`,`pensamentos automáticos`,`cognição`],ageGroups:[`adulto`,`adolescente`],Icon:c,template:`REGISTRO DE PENSAMENTOS AUTOMÁTICOS
...
OBSERVAÇÕES DO(A) PROFISSIONAL:`},{id:`funcionalidade`,title:`Avaliação de Funcionalidade Global`,description:`Avaliação do funcionamento em trabalho, relacionamentos, autocuidado e autonomia.`,category:`formulario`,tags:[`funcionalidade`,`AVD`,`qualidade de vida`],ageGroups:[`adulto`],Icon:i,template:`AVALIAÇÃO DE FUNCIONALIDADE GLOBAL
...
CONCLUSÕES E PRÓXIMOS PASSOS:`},{id:`conceptualizacao-cognitiva`,title:`Conceitualização Cognitiva (TCC)`,description:`Formulação do caso no modelo cognitivo: dados relevantes, crenças centrais, estratégias e situações-problema.`,category:`formulario`,tags:[`TCC`,`conceitualização`,`crenças centrais`,`formulação de caso`],ageGroups:[`adulto`,`adolescente`],Icon:c,template:`CONCEITUALIZAÇÃO COGNITIVA — FORMULAÇÃO DE CASO (TCC)
...
OBSERVAÇÕES DO(A) PROFISSIONAL:`}];function R(e,t){if(!e.trim())return(0,N.jsx)(`div`,{className:`h-2`},t);if(e===e.toUpperCase()&&e.trim().length>2&&/^[A-ZÁÀÃÂÉÊÍÓÔÕÚÜÇ\s/—]+$/.test(e.trim()))return(0,N.jsxs)(`div`,{className:`flex items-center gap-3 pt-2`,children:[(0,N.jsx)(`p`,{className:`text-[10px] font-bold uppercase tracking-widest text-neutral-500 whitespace-nowrap`,children:e.trim()}),(0,N.jsx)(`div`,{className:`flex-1 h-px bg-neutral-200`})]},t);let n=e.indexOf(`:`);if(n>0){let r=e.slice(0,n).trim(),i=e.slice(n+1).trim();return(0,N.jsxs)(`div`,{className:`grid grid-cols-[180px_1fr] gap-3 items-end py-1 border-b border-dashed border-neutral-150`,children:[(0,N.jsx)(`span`,{className:`text-[11px] font-semibold text-neutral-500 pb-0.5 leading-tight`,children:r}),(0,N.jsx)(`span`,{className:`text-sm text-neutral-700 pb-0.5 min-h-[1.5rem]`,children:i||(0,N.jsx)(`span`,{className:`text-neutral-200 select-none`,children:`_`})})]},t)}return(0,N.jsx)(`p`,{className:`text-xs text-neutral-400 italic py-0.5`,children:e},t)}function z({instrument:e,onClose:t}){if(!e)return null;let r=e,i=r.template.split(`
`),a=i.filter(e=>e.trim().endsWith(`:`)).length;function o(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function s(){let e=window.open(``,`_blank`);if(!e){n.error(`Não foi possível abrir a janela de impressão.`);return}let t=i.map(e=>{if(!e.trim())return`<div style="height:8px"></div>`;if(e===e.toUpperCase()&&e.trim().length>2&&/^[A-ZÁÀÃÂÉÊÍÓÔÕÚÜÇ\s/—]+$/.test(e.trim()))return`<div style="display:flex;align-items:center;gap:8px;padding:8px 0 4px">
          <span style="font-size:8.5px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:#6b7280;white-space:nowrap">${o(e.trim())}</span>
          ...
          <span style="font-size:9px;font-weight:600;color:#6b7280;padding-top:2px">${o(e.slice(0,t).trim())}</span>
          <span style="font-size:11px;color:#374151;padding-bottom:3px">${o(e.slice(t+1).trim())||``}</span></div>`:`<p style="font-size:9px;color:#9ca3af;font-style:italic;margin:2px 0">${o(e)}</p>`}).join(``),s=P[r.category];e.document.write(`<!doctype html><html><head><title>${o(r.title)}</title>
<style>
...
<div class="header">
  <p style="font-size:14px;font-weight:700;margin:0 0 2px">${o(r.title)}</p>
  <p style="font-size:9.5px;color:#6b7280;margin:0 0 4px">${o(r.description)}</p>
  <span class="badge">${o(s)}</span>
  <span class="badge" style="margin-left:4px">${a} campos</span>
...
</div></body></html>`),e.document.close(),setTimeout(()=>{e.focus(),e.print()},150)}return(0,N.jsx)(j,{open:!!e,onClose:t,title:e.title,size:`lg`,children:(0,N.jsxs)(`div`,{className:`space-y-4`,children:[(0,N.jsxs)(`div`,{className:`flex items-start gap-3 rounded-2xl border border-neutral-100 bg-neutral-50 px-4 py-3`,children:[(0,N.jsx)(e.Icon,{className:`w-5 h-5 text-sage-600 mt-0.5 shrink-0`}),(0,N.jsxs)(`div`,{className:`flex-1 min-w-0`,children:[(0,N.jsx)(`p`,{className:`text-sm text-neutral-600 leading-relaxed`,children:e.description}),(0,N.jsxs)(`div`,{className:`flex flex-wrap gap-1.5 mt-2`,children:[(0,N.jsx)(`span`,{className:`text-[11px] font-semibold px-2 py-0.5 rounded-full ${F[e.category]}`,children:P[e.category]}),e.tags.map(e=>(0,N.jsx)(`span`,{className:`text-[11px] text-neutral-400 bg-neutral-100 px-2 py-0.5 rounded-full`,children:e},e))]})]}),(0,N.jsxs)(`span`,{className:`text-xs text-neutral-400 shrink-0`,children:[a,` campos`]})]}),(0,N.jsxs)(`div`,{className:`rounded-2xl border border-neutral-200 bg-white overflow-hidden`,children:[(0,N.jsxs)(`div`,{className:`bg-neutral-50 border-b border-neutral-100 px-5 py-3 flex items-center justify-between`,children:[(0,N.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,N.jsx)(`div`,{className:`h-2 w-2 rounded-full bg-sage-400`}),(0,N.jsx)(`span`,{className:`text-xs font-medium text-neutral-500`,children:`Formulário para preenchimento`})]}),(0,N.jsxs)(`div`,{className:`flex items-center gap-3 text-xs text-neutral-400`,children:[(0,N.jsxs)(`span`,{children:[`Profissional: `,(0,N.jsx)(`span`,{className:`inline-block w-24 border-b border-neutral-300`,children:`\xA0`})]}),(0,N.jsxs)(`span`,{children:[`Data: `,(0,N.jsx)(`span`,{className:`inline-block w-16 border-b border-neutral-300`,children:`\xA0`})]})]})]}),(0,N.jsx)(`div`,{className:`px-5 py-4 space-y-0.5 max-h-[50vh] overflow-y-auto`,children:i.map((e,t)=>R(e,t))})]}),(0,N.jsxs)(`div`,{className:`flex items-center justify-between`,children:[(0,N.jsx)(`p`,{className:`text-xs text-neutral-400`,children:`Instrumento de apoio clínico · não substitui prontuário oficial`}),(0,N.jsxs)(`div`,{className:`flex gap-3`,children:[(0,N.jsx)(`button`,{type:`button`,onClick:t,className:`btn-secondary text-sm`,children:`Fechar`}),(0,N.jsxs)(`button`,{type:`button`,onClick:s,className:`btn-primary text-sm flex items-center gap-2`,children:[(0,N.jsx)(_,{className:`w-4 h-4`}),`Imprimir / PDF`]})]})]})]})})}function B({instrument:e,index:t,onClick:n}){let r=I[t%I.length],i=e.template.split(`
`).filter(e=>e.trim().endsWith(`:`)).length;return(0,N.jsxs)(`button`,{type:`button`,onClick:n,className:`card group flex flex-col items-start gap-3 p-4 text-left hover:shadow-lifted hover:-translate-y-px transition-all duration-200 hover:border-sage-200 cursor-pointer`,children:[(0,N.jsx)(`div`,{className:`flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl ring-1 ${r}`,children:(0,N.jsx)(e.Icon,{className:`w-5 h-5`})}),(0,N.jsxs)(`div`,{className:`flex-1 min-w-0 w-full`,children:[(0,N.jsxs)(`div`,{className:`flex items-start justify-between gap-2`,children:[(0,N.jsx)(`p`,{className:`text-sm font-semibold text-neutral-800 leading-tight`,children:e.title}),(0,N.jsx)(`span`,{className:`shrink-0 text-[10px] font-semibold px-1.5 py-0.5 rounded-full ${F[e.category]}`,children:P[e.category]})]}),(0,N.jsx)(`p`,{className:`mt-1 text-xs leading-relaxed text-neutral-400 line-clamp-2`,children:e.description}),(0,N.jsx)(`div`,{className:`flex flex-wrap gap-1 mt-2`,children:e.tags.slice(0,3).map(e=>(0,N.jsx)(`span`,{className:`text-[10px] text-neutral-400 bg-neutral-50 border border-neutral-100 px-1.5 py-0.5 rounded-full`,children:e},e))})]}),(0,N.jsxs)(`div`,{className:`flex w-full items-center justify-between pt-1 border-t border-neutral-100`,children:[(0,N.jsxs)(`span`,{className:`text-[11px] text-neutral-300`,children:[i,` campos`]}),(0,N.jsx)(`span`,{className:`text-xs font-medium text-sage-600 group-hover:text-sage-700`,children:`Abrir →`})]})]})}var V=[{value:`all`,label:`Todos`},{value:`formulario`,label:`Formulários`},{value:`escala`,label:`Escalas`},{value:`registro`,label:`Registros`},{value:`entrevista`,label:`Entrevistas`}],H=[{value:`all`,label:`Todas as idades`},{value:`infantil`,label:`Infantil`},{value:`adolescente`,label:`Adolescente`},{value:`adulto`,label:`Adulto`}];function U(){let[e,t]=(0,M.useState)(``),[n,r]=(0,M.useState)(`all`),[i,a]=(0,M.useState)(`all`),[s,c]=(0,M.useState)(null),l=(0,M.useMemo)(()=>{let t=e.toLowerCase().trim();return L.filter(e=>{let r=n===`all`||e.category===n,a=i===`all`||e.ageGroups.includes(i)||e.ageGroups.includes(`all`),o=!t||e.title.toLowerCase().includes(t)||e.description.toLowerCase().includes(t)||e.tags.some(e=>e.toLowerCase().includes(t));return r&&a&&o})},[e,n,i]);return(0,N.jsxs)(`div`,{className:`animate-slide-up space-y-5`,children:[(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`h1`,{className:`page-title`,children:`Instrumentos Clínicos`}),(0,N.jsx)(`p`,{className:`page-subtitle`,children:`Formulários, escalas e registros para apoio clínico`})]}),(0,N.jsxs)(`div`,{className:`relative`,children:[(0,N.jsx)(o,{className:`absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-neutral-400`}),(0,N.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:`Buscar por nome, descrição ou assunto...`,className:`input-field pl-9 py-2.5 text-sm`}),e&&(0,N.jsx)(`button`,{onClick:()=>t(``),className:`absolute right-3 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-neutral-600`,children:(0,N.jsx)(T,{className:`w-4 h-4`})})]}),(0,N.jsxs)(`div`,{className:`flex flex-col sm:flex-row gap-2`,children:[(0,N.jsx)(`div`,{className:`flex gap-1 bg-neutral-100 p-1 rounded-xl overflow-x-auto scrollbar-none`,children:V.map(({value:e,label:t})=>(0,N.jsx)(`button`,{onClick:()=>r(e),className:`flex-none px-3 py-1.5 rounded-lg text-xs transition-all whitespace-nowrap ${n===e?`bg-white shadow-sm font-medium text-neutral-800`:`text-neutral-500`}`,children:t},e))}),(0,N.jsx)(`div`,{className:`flex gap-1 bg-neutral-100 p-1 rounded-xl overflow-x-auto scrollbar-none`,children:H.map(({value:e,label:t})=>(0,N.jsx)(`button`,{onClick:()=>a(e),className:`flex-none px-3 py-1.5 rounded-lg text-xs transition-all whitespace-nowrap ${i===e?`bg-white shadow-sm font-medium text-neutral-800`:`text-neutral-500`}`,children:t},e))})]}),(0,N.jsxs)(`p`,{className:`text-xs text-neutral-400`,children:[l.length,` instrumento`,l.length===1?``:`s`,` encontrado`,l.length===1?``:`s`]}),l.length===0?(0,N.jsxs)(`div`,{className:`card py-16 text-center`,children:[(0,N.jsx)(`p`,{className:`text-sm text-neutral-400`,children:`Nenhum instrumento encontrado para os filtros selecionados.`}),(0,N.jsx)(`button`,{onClick:()=>{t(``),r(`all`),a(`all`)},className:`mt-3 text-xs text-sage-600 hover:underline`,children:`Limpar filtros`})]}):(0,N.jsx)(`div`,{className:`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3`,children:l.map((e,t)=>(0,N.jsx)(B,{instrument:e,index:t,onClick:()=>c(e)},e.id))}),(0,N.jsxs)(`p`,{className:`text-xs text-neutral-400 border-t border-neutral-100 pt-4`,children:[`Testes psicológicos privativos devem ser utilizados exclusivamente por psicólogas(os) habilitados, conforme orientação do CFP e lista do`,` `,(0,N.jsx)(`a`,{href:`https://satepsi.cfp.org.br/`,target:`_blank`,rel:`noreferrer`,className:`text-sage-600 hover:underline`,children:`SATEPSI`}),`. As escalas de rastreio aqui listadas são de uso clínico livre e não substituem avaliação psicológica formal.`]}),(0,N.jsx)(z,{instrument:s,onClose:()=>c(null)})]})}export{U as default};