...
OBSERVAÇÕES:`},{id:`contrato-terapeutico`,title:`Contrato Terapêutico / Combinados`,description:`Honorários, faltas, cancelamento, sigilo, comunicação, emergências e proteção de dados.`,category:`formulario`,tags:[`contrato`,`ética`,`sigilo`,`LGPD`],ageGroups:[`all`],Icon:x,template:`CONTRATO TERAPÊUTICO / COMBINADOS
...
Assinatura/data:`},{id:`triagem-inicial`,title:`Entrevista de Triagem Inicial`,description:`Avaliação breve de demanda, urgência, risco, disponibilidade e adequação ao atendimento.`,category:`entrevista`,tags:[`triagem`,`avaliação inicial`,`risco`],ageGroups:[`all`],Icon:o,template:`ENTREVISTA DE TRIAGEM INICIAL
...
Observações:`},{id:`entrevista-motivacional`,title:`Entrevista Motivacional`,description:`Exploração da ambivalência, estágio de mudança, importância, confiança e próximos passos.`,category:`entrevista`,tags:[`motivação`,`mudança`,`ambivalência`,`EM`],ageGroups:[`adulto`,`adolescente`],Icon:E,template:`ENTREVISTA MOTIVACIONAL
...
OBSERVAÇÕES DO(A) PROFISSIONAL:`},{id:`funcionalidade`,title:`Avaliação de Funcionalidade Global`,description:`Avaliação do funcionamento em trabalho, relacionamentos, autocuidado e autonomia.`,category:`formulario`,tags:[`funcionalidade`,`AVD`,`qualidade de vida`],ageGroups:[`adulto`],Icon:v,template:`AVALIAÇÃO DE FUNCIONALIDADE GLOBAL
...
OBSERVAÇÕES DO(A) PROFISSIONAL:`},{id:`exposicao-gradual`,title:`Registro de Exposição Gradual (TCC)`,description:`Hierarquia de exposição e registro de SUDS antes, durante e após cada exposição. Técnica TCC.`,category:`registro`,tags:[`TCC`,`exposição`,`ansiedade`,`hierarquia`,`fobia`],ageGroups:[`adulto`,`adolescente`],Icon:_,template:`REGISTRO DE EXPOSIÇÃO GRADUAL — TCC
...
OBSERVAÇÕES DO(A) PROFISSIONAL:`},{id:`grupo-familiar`,title:`Genograma / Mapa Familiar`,description:`Registro descritivo da estrutura familiar, vínculos e padrões transgeracionais.`,category:`formulario`,tags:[`família`,`genograma`,`sistêmica`],ageGroups:[`all`],Icon:T,template:`GENOGRAMA / MAPA FAMILIAR
...
<div class="header">
  ...
  <span class="badge" style="margin-left:4px">${s} campos</span>
