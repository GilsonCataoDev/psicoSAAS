...
8. Android fica em standby ate haver aparelho fisico para QA ativo.
9. iOS: sincronizar assets com `npm run cap:sync:ios`.
10. Em um Mac: abrir `frontend/ios/App/App.xcodeproj`, configurar Apple Team e rodar em simulador/iPhone.
11. Criar conta Apple Developer.
12. Preparar politica, screenshots, descricao e revisao das permissoes.
