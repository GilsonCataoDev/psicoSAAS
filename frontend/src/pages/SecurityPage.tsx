  ...
  return (
    <main className="min-h-screen bg-[#F7F8F5] text-[#211F1C]">
      <header className="border-b border-[#E7E4DA] bg-white/90 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5">
          ...
          <nav className="flex items-center gap-4 text-sm font-semibold">
            <Link to="/privacidade" className="hidden text-sage-800 hover:text-sage-950 sm:block">Privacidade</Link>
            <Link to="/cadastro" className="rounded-md bg-sage-800 px-4 py-2 text-white hover:bg-sage-900">Conhecer</Link>
          </nav>
        </div>
      </header>
      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-5 py-16 lg:grid-cols-[0.9fr_1.1fr] lg:py-20">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-sage-200 bg-white px-3 py-1 text-xs font-bold uppercase tracking-[0.15em] text-sage-700">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <a href="mailto:contato@usecognia.com.br?subject=Segurança%20UseCognia" className="inline-flex h-12 items-center justify-center rounded-md border border-sage-200 bg-white px-5 text-sm font-bold text-sage-900 hover:bg-sage-50">
              Tirar uma dúvida
            </a>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-sage-100 bg-white p-6 shadow-card">
          <p className="text-sm font-semibold text-sage-800">Controles ativos na plataforma</p>
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            {controls.map((item) => (
              <div key={item} className="flex items-start gap-3 rounded-xl border border-[#E7E4DA] bg-[#FBFCFA] px-4 py-3">
                <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-sage-600" />
                <span className="text-sm font-medium leading-relaxed text-[#49443D]">{item}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="mx-auto grid max-w-6xl gap-8 px-5 py-14 lg:grid-cols-2">
        <article className="rounded-2xl border border-sage-200 bg-sage-50 p-6">
          <LockKeyhole className="h-6 w-6 text-sage-700" />
          <h2 className="mt-4 text-xl font-bold text-sage-950">Isolamento testado entre contas</h2>
          <p className="mt-3 text-sm leading-relaxed text-sage-900">
        ...
        <article className="rounded-2xl border border-[#E7E4DA] bg-white p-6">
          <FileCheck2 className="h-6 w-6 text-sage-700" />
          <h2 className="mt-4 text-xl font-bold">Privacidade e portabilidade</h2>
          ...
          <Link to="/privacidade" className="mt-4 inline-flex items-center gap-2 text-sm font-bold text-sage-700 hover:text-sage-900">
      ...
      <section className="border-y border-amber-200 bg-amber-50">
        <div className="mx-auto max-w-4xl px-5 py-12">
          <h2 className="text-xl font-bold text-amber-950">Transparência sobre limites</h2>
          <ul className="mt-5 grid gap-3">
            {transparency.map((item) => (
              <li key={item} className="flex items-start gap-3 text-sm leading-relaxed text-amber-950">
                <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-amber-700" /> {item}
              </li>
            ))}
          </ul>
        </div>
      ...
      <section className="mx-auto max-w-4xl px-5 py-14 text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-[#6F6A61]">
        ...
        <a href="mailto:contato@usecognia.com.br?subject=Relato%20de%20segurança" className="mt-6 inline-flex h-11 items-center justify-center rounded-md bg-sage-800 px-5 text-sm font-bold text-white hover:bg-sage-900">
          Relatar com responsabilidade
        </a>
        <p className="mt-6 text-xs text-[#817B72]">Última revisão técnica: julho de 2026.</p>
      </section>
    </main>
  )
}
