...
export const JOB_LOCK_KEYS = {
  ...
  PROSPECTING_DISCOVER:      1007,
  PROSPECTING_ANALYZE:       1008,
  PROSPECTING_EXPIRE:        1009,
  PROSPECTING_RETRY:         1010,
  ...
  WHATSAPP_OUTBOX_RECONCILIATION: 1017,
  SALES_COMMISSION_RELEASE: 1018,
} as const
