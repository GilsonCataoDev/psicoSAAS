...
class CreateRefreshTokensTable1714500000000 {
    async up(queryRunner) {
        ...
        if (!hasRefreshTokens) {
            ...
            if (table?.findColumnByName('ipAddress')) {
                await queryRunner.query('UPDATE "refresh_tokens" SET "ip" = COALESCE("ip", "ipAddress")');
            }
        }
    ...
    `);
        ...
        await queryRunner.query('CREATE INDEX IF NOT EXISTS "IDX_refresh_tokens_expiresAt" ON "refresh_tokens" ("expiresAt")');
    }
