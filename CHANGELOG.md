...
### Adicionado
- CRM conversacional no admin de prospeccao, acessivel pelo detalhe do lead, com conversas por canal, rascunho, aprovacao, envio manual e registro de resposta.
- Modelo personalizavel para lembrete automatico de pagamento em atraso.
...
### Corrigido
- Prospecao admin agora usa CSRF, corrige metricas de conversas e bloqueia envio externo fake quando nao ha provider real configurado.
